...
// //                         type="text"
// //                         placeholder="Search..."
// //                         className="w-full border-gray-200 rounded-xl pl-10 pr-4 py-3 bg-gray-50 border-2 text-sm focus:outline-none focus:border-indigo-500"
// //                     />
// //                 </div>

// //                 <select className="px-4 py-3 ■bg-gray-50 border-2 border-gray-200 rounded-xl text-sm font-semibold text-gray-700 focus:outline-none focus:border-indigo-500 cursor-pointer" value={filterCategory}>
...
// //                 {/*Else Map Method*/}
// //                 <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-gray-50 to-white hover:from-white hover:to-gray-50 border border-gray-100 rounded-xl transition-all group">
...
//                             <div className="flex-1 min-w-0">
//                                 <div className="flex items-start justify-between gap-3 mb-1">
//                                     <h4 className="font-bold text-gray-900 truncate overflow-hidden">
//                                         {expense.description}
//                                     </h4>
//                                     <span className="text-xl font-bold text-gray-900 whitespace-nowrap">
...
//                                         <>
//                                             <span className="text-gray-400">•</span>
//                                             <span className="text-gray-500">{expense.notes}</span>
//                                         </>
//                                     )}
//                                 </div>
//                             </div>
